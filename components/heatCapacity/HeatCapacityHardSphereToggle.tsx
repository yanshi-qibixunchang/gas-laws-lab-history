...
const hardSphereToggleCopy = {
  'zh-CN': {
    ...
    on: '开',
    off: '关',
    tooltipOff: '开启瓶内硬球微观可视化，用于观察分子运动、密度和速度变化。',
    tooltipOn: '关闭瓶内硬球微观可视化。该显示仅用于教学解释，不参与数据计算。',
  },
  'zh-TW': {
    label: '微觀可視化',
    on: '開',
    off: '關',
    tooltipOff: '開啟瓶內硬球微觀可視化，用於觀察分子運動、密度和速度變化。',
    tooltipOn: '關閉瓶內硬球微觀可視化。該顯示僅用於教學解釋，不參與資料計算。',
  },
  en: {
    label: 'Hard-Sphere View',
    on: 'ON',
    off: 'OFF',
    tooltipOff: 'Enable the in-bottle hard-sphere teaching view for molecular motion, density, and speed changes.',
    tooltipOn: 'Disable the in-bottle hard-sphere teaching view. This display is explanatory only and is not used in calculations.',
  },
} as const;
