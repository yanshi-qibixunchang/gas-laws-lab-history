  ...
  return (
    <div 
      className={`
        ...
        rounded-panel overflow-hidden transition-all duration-300 ease-out
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          {icon && <span className="text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 p-2 rounded-panel">{icon}</span>}
