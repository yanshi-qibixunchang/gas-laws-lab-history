...
const COPY = {
  'zh-CN': {
    ...
    knownGroup: (index: number) => `第 ${index + 1} 组数据与过程量`,
    knownAggregate: '批次统计量',
    knownGuide: '计算已知量',
    groupTab: (index: number) => `第 ${index + 1} 组`,
    aggregateTab: '汇总计算',
    futureGroup: '完成前序组计算后解锁',
    futureAggregate: '完成全部单组计算后解锁',
    reference: '参考答案：',
    correct: '正确',
    revealed: '已显示答案',
    systemValue: '系统值',
  ...
  'zh-TW': {
    ...
    knownGroup: (index: number) => `第 ${index + 1} 組資料與過程量`,
    knownAggregate: '批次統計量',
    knownGuide: '計算已知量',
    groupTab: (index: number) => `第 ${index + 1} 組`,
    aggregateTab: '彙總計算',
    futureGroup: '完成前序組計算後解鎖',
    futureAggregate: '完成全部單組計算後解鎖',
    reference: '參考答案：',
    correct: '正確',
    revealed: '已顯示答案',
    systemValue: '系統值',
  ...
  en: {
    ...
    knownGroup: (index: number) => `Group ${index + 1} data and derived values`,
    knownAggregate: 'Batch statistics',
    knownGuide: 'Known values',
    groupTab: (index: number) => `Group ${index + 1}`,
    aggregateTab: 'Summary',
    futureGroup: 'Complete the preceding group calculations to unlock',
    futureAggregate: 'Complete all group calculations to unlock',
    reference: 'Reference: ',
    correct: 'Correct',
    ...
    stepTitle: {
      ...
      groupGamma: 'Calculate the group heat-capacity ratio',
      ...
      batchRelativeError: 'Calculate batch relative error',
    },
  },
} as const;
