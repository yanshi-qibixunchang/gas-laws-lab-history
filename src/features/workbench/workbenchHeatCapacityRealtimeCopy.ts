...
export const heatCapacityRealtimeCopies = {
  'zh-CN': {
    ...
    gasCalculationHint: (gasLabel: string) => `U₁ / U₂ 与${gasLabel}比热容比计算`,
    gasExperimentTitle: (gasLabel: string) => `${gasLabel}比热容比实验`,
    gasMaterialsTabsAria: (gasLabel: string) => `${gasLabel}比热容比实验资料分页`,
    gasPreviewMountAria: (gasLabel: string) => `${gasLabel}比热容比视图预览区域`,
  ...
  'zh-TW': {
    ...
    gasCalculationHint: (gasLabel: string) => `U₁ / U₂ 與${gasLabel}比熱容比計算`,
    gasExperimentTitle: (gasLabel: string) => `${gasLabel}比熱容比實驗`,
    gasMaterialsTabsAria: (gasLabel: string) => `${gasLabel}比熱容比實驗資料分頁`,
    gasPreviewMountAria: (gasLabel: string) => `${gasLabel}比熱容比視圖預覽區域`,
  ...
  en: {
    ...
    gasCalculationHint: (gasLabel: string) => `U1 / U2 and ${gasLabel} heat-capacity-ratio calculation`,
    gasExperimentTitle: (gasLabel: string) => `${gasLabel} Heat Capacity Ratio Experiment`,
    gasMaterialsTabsAria: (gasLabel: string) => `${gasLabel} heat-capacity-ratio experiment materials tabs`,
    gasPreviewMountAria: (gasLabel: string) => `${gasLabel} heat-capacity-ratio viewport preview`,
