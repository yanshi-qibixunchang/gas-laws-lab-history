...
const COPY = {
  'zh-CN': {
    ...
    customTitle: '自定义高度',
    customHint: '可添加任意数量的 10 至 80 mm 整数候选；计划仍只能选择 3 至 6 个高度。',
    customInputAria: '输入自定义高度',
    customPlaceholder: '例如 65',
    addCustom: '添加',
    customEmpty: '还没有添加自定义高度。',
    customInvalid: '请输入 10 至 80 的整数。',
  ...
  'zh-TW': {
    ...
    customTitle: '自訂高度',
    customHint: '可加入任意數量的 10 至 80 mm 整數候選；計畫仍只能選擇 3 至 6 個高度。',
    customInputAria: '輸入自訂高度',
    customPlaceholder: '例如 65',
    addCustom: '加入',
    customEmpty: '尚未加入自訂高度。',
    customInvalid: '請輸入 10 至 80 的整數。',
  ...
  en: {
    ...
    customHint: 'Add any number of whole-number candidates from 10 to 80 mm; the plan still uses only 3 to 6 heights.',
    customInputAria: 'Enter a custom height',
    customPlaceholder: 'For example, 65',
    addCustom: 'Add',
    customEmpty: 'No custom heights added yet.',
    customInvalid: 'Enter a whole number from 10 to 80.',
