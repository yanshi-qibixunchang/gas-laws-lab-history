...
export const ProductIntroOutcomeDemo = ({
  ...
  const elapsedMs = Math.max(0, controlledElapsedMs);
        ...
        >
          ...
          <div className="studio-results-toolbar studio-heat-materials-toolbar">
            <div className="studio-results-title">
              <strong>实验资料与结果</strong>
              <span>完整过程、计算结果与操作评分</span>
            </div>
            <div className="studio-results-actions">
              <button type="button" aria-label="关闭实验资料与结果" tabIndex={-1}>
                <X size={14} />
              </button>
            </div>
          </div>
          <div className="studio-results-tabs studio-heat-materials-tabs" role="tablist" aria-label="实验资料与结果标签页">
