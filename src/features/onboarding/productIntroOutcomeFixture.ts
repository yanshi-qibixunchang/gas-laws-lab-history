...
const DIAGNOSTICS: HeatCapacityProcessDiagnosisRow[] = [
  {
    ...
    maxScore: 20,
    details: [
      { id: 'pumping-pressure-target', label: '目标压强', score: 8, maxScore: 8, status: 'reasonable', evidence: 'U1 修正量 112.0 mV。', reason: '无误。', recommendation: '无误。' },
      { id: 'pumping-safety', label: '安全提示', score: 6, maxScore: 6, status: 'reasonable', evidence: '未触发压力预警或报警。', reason: '无误。', recommendation: '无误。' },
      { id: 'pumping-rhythm', label: '打气节奏', score: 4, maxScore: 4, status: 'reasonable', evidence: '打气间隔稳定。', reason: '无误。', recommendation: '无误。' },
      { id: 'pumping-stability', label: '稳定等待', score: 2, maxScore: 2, status: 'reasonable', evidence: 'U1 记录点稳定。', reason: '无误。', recommendation: '无误。' },
    ],
  },
  {
    id: 'release',
    ...
    maxScore: 30,
    details: [
      { id: 'release-valve', label: '开阀放气', score: 14, maxScore: 14, status: 'reasonable', evidence: '放气 0.6 s。', reason: '无误。', recommendation: '无误。' },
      { id: 'release-response', label: '泄放响应', score: 8, maxScore: 8, status: 'reasonable', evidence: 'U2/U1 = 0.28。', reason: '无误。', recommendation: '无误。' },
      { id: 'release-recover', label: '关阀回温', score: 4, maxScore: 4, status: 'reasonable', evidence: '关阀后进入恢复记录段。', reason: '无误。', recommendation: '无误。' },
      { id: 'release-retention', label: 'U2 保留量', score: 4, maxScore: 4, status: 'reasonable', evidence: 'U2/U1 = 0.28。', reason: '无误。', recommendation: '无误。' },
    ],
  },
  {
    id: 'recording',
    ...
    maxScore: 40,
    details: [
      { id: 'record-chain-completeness', label: '数据完整性', score: 5, maxScore: 5, status: 'reasonable', evidence: 'U1 / U2 与计算结果完整。', reason: '无误。', recommendation: '无误。' },
      { id: 'record-chain-result', label: '结果合理性', score: 12, maxScore: 12, status: 'reasonable', evidence: 'γ = 1.400，绝对误差 0.000。', reason: '无误。', recommendation: '无误。' },
      { id: 'record-chain-zeroing', label: '调零与 U0', score: 10, maxScore: 10, status: 'reasonable', evidence: 'U0 = 0.00 mV。', reason: '无误。', recommendation: '无误。' },
      { id: 'record-chain-timing', label: '记录时机', score: 10, maxScore: 10, status: 'reasonable', evidence: 'U1 稳定，U2 稳定。', reason: '无误。', recommendation: '无误。' },
  ...
  },
  {
    ...
    maxScore: 10,
    details: [
      { id: 'retake-count', label: '重录情况', score: 10, maxScore: 10, status: 'reasonable', evidence: '无隐藏分支。', reason: '无误。', recommendation: '无误。' },
    ],
  },
];
