...
import { AppMode, SimulationParams, SimulationStats, ChartData, LanguageCode, SavedConfig, InputCapabilities, Translation } from '../shared/types';
...
const IdealGasExperimentMode = lazy(() => import('../features/idealGas/IdealGasExperimentMode'));
...
function App() {
  ...
  useEffect(() => {
    void import('../features/idealGas/IdealGasExperimentMode');
  }, []);
