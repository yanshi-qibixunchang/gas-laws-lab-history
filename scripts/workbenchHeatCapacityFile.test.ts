...
assert.equal(file.heatCapacityState.instrument.instrumentPowered, false);
assert.equal(file.heatCapacityState.instrument.highlightedPart, 'Instrument_Box_Power_Switch');
assert.deepEqual(file.heatCapacityState.instrument.secondaryHighlightedParts, ['Instrument_Box_Power_Light', 'Instrument_Box']);
