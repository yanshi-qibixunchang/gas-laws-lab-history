...
} from '../components/heatCapacity/heatCapacityFreeCalibrationModel.ts';
import {
  applyFreePumpStroke,
...
} from '../components/heatCapacity/heatCapacityFreePhysicsEngine.ts';
import {
...
} from '../components/heatCapacity/heatCapacityFreeSensorModel.ts';
import {
...
} from '../components/heatCapacity/heatCapacityFreeRecordModel.ts';
import {
...
const DEFAULT_PUMP_STROKES = [6, 7, 8, 9, 10, 11, 12];
...
if (process.argv[1]?.replace(/\\/g, '/').endsWith('/scripts/heatCapacityFreeParameterAcceptance.ts')) {
