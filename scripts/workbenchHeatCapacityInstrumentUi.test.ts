...
assert.match(sceneSource, /data-heat-capacity-hard-sphere-note="true"/, 'hard-sphere explanation note should have a stable UI marker');
...
assert.match(styleSource, /--heat-hard-sphere-top: clamp\(124px, 18%, 188px\)/, 'hard-sphere toggle should sit in the model-window left mid-upper overlay area');
assert.match(styleSource, /\.studio-heat-hard-sphere-toggle \{[\s\S]*left: var\(--heat-hard-sphere-left\);[\s\S]*top: var\(--heat-hard-sphere-top\);/, 'hard-sphere toggle should use the dedicated scene overlay position');
