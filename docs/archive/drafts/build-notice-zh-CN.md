...
> 归档状态：2026-08-31 归档。本文保留原审核现场，其中 PDF.js、Capacitor 和“暂未接入软件界面”等表述已经过期；当前核验基线见 `docs/legal/build-notice-zh-CN.md`。

- 文档状态：正文审核稿，暂未接入软件界面。
- 适用位置：帮助 > 关于气律实验室 > 构建说明。
- 当前项目版本：6.4.0。
- 审核日期：2026 年 8 月 30 日。
...
| 音效素材与许可 | 热容比实验音效的来源、作者、链接、CC0 许可和程序化音效说明 |
| 3D 模型来源 | 活塞振动法混合精修模型与共享实验台的来源版本、SHA-256、精修范围和权利状态 |
