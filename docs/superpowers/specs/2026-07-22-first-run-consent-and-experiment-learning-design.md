...
> 状态：颗粒度已确认；第一、第二小版本已实现，第二小版本待用户体验验收，第三小版本待实施
>
> 确认日期：2026-07-22
>
> 适用范围：桌面版与网页版；当前落地绝热膨胀法实验，并为活塞振动法实验预留扩展能力
>
> 详细实施计划：`docs/superpowers/plans/2026-07-22-first-run-consent-and-experiment-learning-implementation-plan.md`
