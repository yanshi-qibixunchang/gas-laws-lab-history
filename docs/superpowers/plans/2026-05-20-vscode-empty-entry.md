...
```powershell
git add src/features/workbench/WorkbenchStudioPrototype.tsx src/features/workbench/WorkbenchStudioPrototype.css tests/workbench/workbenchChromePolish.test.ts docs/superpowers/specs/2026-05-20-vscode-empty-entry-design.md docs/superpowers/plans/2026-05-20-vscode-empty-entry.md
