...
**2026-06-19 调整：** 推进顺序改为“先完成全部模型优化，再统一调参和六类验收，最后再适配 UI”。UI 待适配和 UI 待添加清单仍保留，但在三个新增模型完成前不作为执行入口。三模型详细计划见 `docs/superpowers/plans/2026-06-19-heat-capacity-free-mode-model-first-optimization.md`。
...
```text
docs/superpowers/plans/2026-06-19-heat-capacity-free-mode-model-first-optimization.md
```
