...
const workbenchPath = join(root, 'src', 'features', 'workbench', 'WorkbenchStudioPrototype.tsx');
const scenePath = join(root, 'src', 'features', 'heatCapacity', 'HeatCapacityInstrumentScene.tsx');
const stylePath = join(root, 'src', 'features', 'workbench', 'WorkbenchStudioPrototype.css');
const motionPath = join(root, 'src', 'features', 'workbench', 'usePreviewOverlayMotion.ts');
const simulationCanvasPath = join(root, 'src', 'components', 'SimulationCanvas.tsx');
