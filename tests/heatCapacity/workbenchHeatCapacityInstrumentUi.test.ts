...
assert.match(workbenchSource, /performanceModeUltra/, 'general settings copy should include the new ultra performance tier');
...
assert.match(workbenchSource, /performanceModeUltra:\s*'极致画质'/, 'ultra tier should be labeled in Simplified Chinese');
...
assert.match(workbenchSource, /performanceModeUltra:\s*'極致畫質'/, 'ultra tier should be localized in Traditional Chinese');
...
assert.match(workbenchSource, /performanceModeUltra:\s*'Ultra'/, 'ultra tier should be localized in English settings');
...
assert.match(workbenchSource, /const performanceModeOptions = useMemo\(\(\) => \(\[[\s\S]*mode: 'performance'[\s\S]*mode: 'balanced'[\s\S]*mode: 'standard'[\s\S]*mode: 'ultra'/, 'performance mode options should display as low load, balanced, high performance, then ultra');
