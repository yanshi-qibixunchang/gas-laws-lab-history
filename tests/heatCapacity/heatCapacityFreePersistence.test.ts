...
assert.equal(payload.free?.config.physics.pumpInflowTemperatureRiseK, 42);
...
(legacyPayload.free!.config.physics as unknown as Record<string, unknown>).releaseMainDurationS = 0.27;
