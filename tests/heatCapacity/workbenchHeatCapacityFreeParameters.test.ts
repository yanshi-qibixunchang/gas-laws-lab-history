...
assert.equal(defaultFile.heatCapacityFreeParameterDraft.gasWallConductanceWPerK, 0.22);
assert.equal(defaultFile.heatCapacityFreeParameterDraft.wallAmbientConductanceWPerK, 0.45);
assert.equal(defaultFile.heatCapacityFreeParameterDraft.leakageEnabled, false);
